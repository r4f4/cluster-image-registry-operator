...
func NewDriver(cfg *imageregistryv1.ImageRegistryConfigStorage, kubeconfig *rest.Config, listers *regopclient.StorageListers, featureGates featuregates.FeatureGate) (Driver, error) {
	var names []string
	var drivers []Driver
	...
	if cfg.S3 != nil {
		...
		drivers = append(drivers, s3.NewDriver(ctx, cfg.S3, listers, featureGates))
	}
